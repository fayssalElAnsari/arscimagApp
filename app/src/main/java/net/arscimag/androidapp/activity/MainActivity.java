package net.arscimag.androidapp.activity;
...
import net.arscimag.androidapp.WebViewAppApplication;
import net.arscimag.androidapp.adapter.DrawerAdapter;
import net.arscimag.androidapp.fragment.MainFragment;
