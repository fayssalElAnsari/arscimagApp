package net.arscimag.androidapp.fragment;
...
import net.arscimag.androidapp.R;
import net.arscimag.androidapp.WebViewAppConfig;
import net.arscimag.androidapp.utility.DownloadUtility;
import net.arscimag.androidapp.utility.Logcat;
import net.arscimag.androidapp.utility.MediaUtility;
import net.arscimag.androidapp.utility.NetworkManager;
import net.arscimag.androidapp.view.ViewState;
